...
SELECT
    ...
    t2.fecha_corte,
    t2.avg_dia_sld_cap_final,
    t2.max_dia_sld_cap_final,
    t2.min_sld_cap_final,
    t2.stddevpop_dia_sld_cap_final,
    t2.max_dia_nueva_altura_mora,
    t2.min_dia_nueva_altura_mora,
    t2.avg_dia_vlr_obligacion,
    t2.max_dia_vlr_obligacion,
    t2.min_dia_vlr_obligacion,
    t2.stddevpop_dia_vlr_obligacion,
    t2.avg_dia_vlr_vencido,
    t2.max_dia_vlr_vencido,
    t2.min_dia_vlr_vencido,
    t2.stddevpop_dia_vlr_vencido
